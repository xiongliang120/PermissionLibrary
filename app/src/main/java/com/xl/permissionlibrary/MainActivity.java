package com.xl.permissionlibrary;
...
import com.xl.permissionlibrary.permission.CheckPermission;
import com.xl.permissionlibrary.permission.PermissionItem;
import com.xl.permissionlibrary.permission.PermissionListener;
import com.xl.permissionlibrary.permission.PermissionUtils;
...
//        startActivityForResult(intent, 100);
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.btn_calendar_req) {
            ...
            CheckPermission.instance(this).check(new PermissionItem(
